...
* @throws ApiError
*/
export const ensureUseAccessControlServiceResourceIntroducersGetManyData = (queryClient: QueryClient, { resourceId, type }: {
  resourceId: number;
  type?: ResourceIntroducerType | undefined;
}) => queryClient.ensureQueryData({ queryKey: Common.UseAccessControlServiceResourceIntroducersGetManyKeyFn({ resourceId, type }), queryFn: () => AccessControlService.resourceIntroducersGetMany({ resourceId, type }) });
/**
...
* @throws ApiError
*/
export const ensureUseResourceHealthServiceGetResourceHealthData = (queryClient: QueryClient, { resourceId }: {
  resourceId: number;
}) => queryClient.ensureQueryData({ queryKey: Common.UseResourceHealthServiceGetResourceHealthKeyFn({ resourceId }), queryFn: () => ResourceHealthService.getResourceHealth({ resourceId }) });
/**
* Find many projects
* @param data The data for the request.
* @param data.page The page number to retrieve
