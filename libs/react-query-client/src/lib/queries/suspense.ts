...
export const usePositionalTrackingServicePositionalTrackingControllerStreamDebugSuspense = <TData = Common.PositionalTrackingServicePositionalTrackingControllerStreamDebugDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UsePositionalTrackingServicePositionalTrackingControllerStreamDebugKeyFn(queryKey), queryFn: () => PositionalTrackingService.positionalTrackingControllerStreamDebug() as TData, ...options });
export const usePositionalTrackingServiceGetPositionalTrackingGatewaysSuspense = <TData = Common.PositionalTrackingServiceGetPositionalTrackingGatewaysDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UsePositionalTrackingServiceGetPositionalTrackingGatewaysKeyFn(queryKey), queryFn: () => PositionalTrackingService.getPositionalTrackingGateways() as TData, ...options });
export const usePositionalTrackingServiceGetPositionalTrackingGatewayByIdSuspense = <TData = Common.PositionalTrackingServiceGetPositionalTrackingGatewayByIdDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>({ id }: {
  id: number;
}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UsePositionalTrackingServiceGetPositionalTrackingGatewayByIdKeyFn({ id }, queryKey), queryFn: () => PositionalTrackingService.getPositionalTrackingGatewayById({ id }) as TData, ...options });
export const usePositionalTrackingServiceGetPositionalTrackingBeaconsSuspense = <TData = Common.PositionalTrackingServiceGetPositionalTrackingBeaconsDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UsePositionalTrackingServiceGetPositionalTrackingBeaconsKeyFn(queryKey), queryFn: () => PositionalTrackingService.getPositionalTrackingBeacons() as TData, ...options });
