...
export const useAuthenticationServiceRefreshSessionSuspense = <TData = Common.AuthenticationServiceRefreshSessionDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseAuthenticationServiceRefreshSessionKeyFn(queryKey), queryFn: () => AuthenticationService.refreshSession() as TData, ...options });
...
export const useAttractapServiceAttractapFirmwareControllerGetFirmwaresSuspense = <TData = Common.AttractapServiceAttractapFirmwareControllerGetFirmwaresDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseAttractapServiceAttractapFirmwareControllerGetFirmwaresKeyFn(queryKey), queryFn: () => AttractapService.attractapFirmwareControllerGetFirmwares() as TData, ...options });
