...
export const useSettingsServiceIsFirstTimeSetupAvailableSuspense = <TData = Common.SettingsServiceIsFirstTimeSetupAvailableDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseSettingsServiceIsFirstTimeSetupAvailableKeyFn(queryKey), queryFn: () => SettingsService.isFirstTimeSetupAvailable() as TData, ...options });
