...
* @throws ApiError
*/
export const useSystemServiceGetSystemInfoSuspense = <TData = Common.SystemServiceGetSystemInfoDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseSystemServiceGetSystemInfoKeyFn(queryKey), queryFn: () => SystemService.getSystemInfo() as TData, ...options });
/**
