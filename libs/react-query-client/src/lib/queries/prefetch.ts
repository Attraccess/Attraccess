...
* @throws ApiError
*/
export const prefetchUseSystemServiceGetSystemInfo = (queryClient: QueryClient) => queryClient.prefetchQuery({ queryKey: Common.UseSystemServiceGetSystemInfoKeyFn(), queryFn: () => SystemService.getSystemInfo() });
/**
