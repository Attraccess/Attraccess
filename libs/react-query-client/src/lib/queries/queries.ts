...
export const useSettingsServiceIsFirstTimeSetupAvailable = <TData = Common.SettingsServiceIsFirstTimeSetupAvailableDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseSettingsServiceIsFirstTimeSetupAvailableKeyFn(queryKey), queryFn: () => SettingsService.isFirstTimeSetupAvailable() as TData, ...options });
