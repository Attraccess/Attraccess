...
export const useSettingsServiceTestSmtpSettings = <TData = Common.SettingsServiceTestSmtpSettingsMutationResult, TError = unknown, TContext = unknown>(options?: Omit<UseMutationOptions<TData, TError, {
  requestBody: UpdateSmtpSettingsDto;
}, TContext>, "mutationFn">) => useMutation<TData, TError, {
  requestBody: UpdateSmtpSettingsDto;
}, TContext>({ mutationFn: ({ requestBody }) => SettingsService.testSmtpSettings({ requestBody }) as unknown as Promise<TData>, ...options });
