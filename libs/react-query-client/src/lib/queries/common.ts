...
export type AuthenticationServiceSsoOidcLogoutMutationResult = Awaited<ReturnType<typeof AuthenticationService.ssoOidcLogout>>;
export type AuthenticationServiceSsoSamlLogoutMutationResult = Awaited<ReturnType<typeof AuthenticationService.ssoSamlLogout>>;
export type AuthenticationServiceSsoOidcDeleteUserMutationResult = Awaited<ReturnType<typeof AuthenticationService.ssoOidcDeleteUser>>;
export type AuthenticationServiceSsoSamlDeleteUserMutationResult = Awaited<ReturnType<typeof AuthenticationService.ssoSamlDeleteUser>>;
export type AuthenticationServiceSsoOidcUpdatePermissionsMutationResult = Awaited<ReturnType<typeof AuthenticationService.ssoOidcUpdatePermissions>>;
export type AuthenticationServiceSsoSamlUpdatePermissionsMutationResult = Awaited<ReturnType<typeof AuthenticationService.ssoSamlUpdatePermissions>>;
...
export type ProjectsServiceArchiveProjectMutationResult = Awaited<ReturnType<typeof ProjectsService.archiveProject>>;
export type ProjectsServiceUnarchiveProjectMutationResult = Awaited<ReturnType<typeof ProjectsService.unarchiveProject>>;
