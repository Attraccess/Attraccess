...
modern snapshots are not treated as legacy. A successful prepared-journal finish
retains a token- and outcome-bound completion receipt for lost-response retries. The `accepted` finish helper has no
