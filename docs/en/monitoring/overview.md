...
Attraccess ships with eight Grafana dashboards, ready to use out of the box:
...
- **Resource Flows** (`attraccess-flow`) -- Per-trigger throughput, success/failure mix, execution latency, per-node-type duration
