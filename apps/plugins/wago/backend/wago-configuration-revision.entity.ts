...
export class WagoConfigurationRevision {
  ...
  @Column({ type: 'varchar', name: 'rejection_acknowledged_at', nullable: true }) rejectionAcknowledgedAt!: string | null;
  @Column({ type: 'integer', name: 'rejection_acknowledged_by', nullable: true }) rejectionAcknowledgedBy!: number | null;
