...
import type { PluginAuditDomainDeclaration, PluginContext, PluginMqttClient } from '@attraccess/plugins-backend-sdk';
...
} from '../../../api/src/plugin-system/plugin-audit-registry';
...
import { discoveryTopic, heartbeatTopic } from '../backend/protocol';
