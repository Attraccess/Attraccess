...
const AppEnvSchema = z
  .object({
    ...
    ATTRACCESS_MDNS_ENABLED: z.coerce.boolean().default(false),
    ATTRACCESS_MDNS_SERVICE_NAME: z.string().min(1).default('Attraccess API'),
    ATTRACCESS_MDNS_SERVICE_TYPE: z.string().min(1).default('attraccess'),
    ATTRACCESS_MDNS_SERVICE_PORT: z.coerce.number().int().positive().optional(),
