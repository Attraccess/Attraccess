...
import { AttractapCoredumpController } from './coredump.controller';
...
@Module({
  ...
  providers: [
    ...
    AttractapCoredumpService,
  ],
  controllers: [
    AttractapController,
    AttractapNfcCardsController,
    AttractapFirmwareController,
    AttractapCoredumpController,
  ],
})
