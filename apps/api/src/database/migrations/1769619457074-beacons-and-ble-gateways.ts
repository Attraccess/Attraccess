...
export class BeaconsAndBleGateways1769619457074 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "ble_gateway" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "identifier" text NOT NULL, "type" varchar CHECK( "type" IN ('gls10','shelly') ) NOT NULL DEFAULT ('gls10'), "mqttServerId" integer NOT NULL, "topic" text, "subscribeQos" integer, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "x" real, "y" real, "txPowerAt1m" real, "pathLossExponent" real, "calibrationUpdatedAt" datetime, CONSTRAINT "UQ_48d39bf9d37b36e4c6efb1adffa" UNIQUE ("identifier"))`);
