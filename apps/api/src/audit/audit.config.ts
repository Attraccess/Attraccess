...
const fields = {
  enabled: z.boolean(),
  domains: z
    .array(z.enum(['administration', 'attractap', 'billing', 'identity', 'project', 'resource', 'sso', 'wago']))
    .max(8),
...
export const auditSettingsSchema = z
  .object({
    ...
    domains: fields.domains.default(['administration', 'attractap', 'identity', 'project', 'resource', 'sso', 'wago']),
