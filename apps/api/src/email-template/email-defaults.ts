...
export const SHIPPED_TRANSLATIONS: ShippedTranslation[] = [
  ...
  { templateType: EmailTemplateType.RESOURCE_USAGE_BILLING_TRANSACTION_SUMMARY, locale: 'de', key: 'billing_factor_applied', value: 'Angewendeter Abrechnungsfaktor: {factor}' },
  { templateType: EmailTemplateType.RESOURCE_USAGE_BILLING_TRANSACTION_SUMMARY, locale: 'de', key: 'item_session_duration', value: 'Sitzungszeit' },
  ...
  { templateType: EmailTemplateType.RESOURCE_USAGE_BILLING_TRANSACTION_SUMMARY, locale: 'de', key: 'col_rate', value: 'Preis' },
