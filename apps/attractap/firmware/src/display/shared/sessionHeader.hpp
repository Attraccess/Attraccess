...
class SessionHeader {
public:
    lv_obj_t *create(lv_obj_t *parent, std::function<void()> onLogout) {
        ...
        userLabel = lv_label_create(info);
        lv_obj_set_width(userLabel, lv_pct(55));
        ...
        timeLabel = lv_label_create(info);
        ...
        // The persistent 62px network badge occupies the top-right of every screen.
        lv_obj_align(timeLabel, LV_ALIGN_TOP_RIGHT, -76, 0);
