...
const char ca_cert_00_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_01_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_02_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_03_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_04_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_05_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_06_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_07_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_08_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_09_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_10_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_11_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_12_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_13_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
MIIDXzCCAkegAwIBAgILBAAAAAABIVhTCKIwDQYJKoZIhvcNAQELBQAwTDEgMB4GA1UECxMXR2xv
YmFsU2lnbiBSb290IENBIC0gUjMxEzARBgNVBAoTCkdsb2JhbFNpZ24xEzARBgNVBAMTCkdsb2Jh
bFNpZ24wHhcNMDkwMzE4MTAwMDAwWhcNMjkwMzE4MTAwMDAwWjBMMSAwHgYDVQQLExdHbG9iYWxT
...
const char ca_cert_14_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_15_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_16_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_17_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_18_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_19_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_20_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_21_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_22_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_23_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_24_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_25_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_26_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_27_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_28_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_29_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_30_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_31_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_32_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_33_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_34_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_35_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_36_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_37_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_38_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_39_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_40_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_41_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_42_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_43_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_44_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_45_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_46_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_47_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_48_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_49_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_50_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_51_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_52_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_53_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_54_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_55_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_56_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_57_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_58_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
MIIFWTCCA0GgAwIBAgIBAjANBgkqhkiG9w0BAQsFADBOMQswCQYDVQQGEwJOTzEdMBsGA1UECgwU
...
const char ca_cert_59_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_60_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_61_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_62_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_63_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_64_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_65_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_66_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
MIIDwzCCAqugAwIBAgIBATANBgkqhkiG9w0BAQsFADCBgjELMAkGA1UEBhMCREUxKzApBgNVBAoM
IlQtU3lzdGVtcyBFbnRlcnByaXNlIFNlcnZpY2VzIEdtYkgxHzAdBgNVBAsMFlQtU3lzdGVtcyBU
...
const char ca_cert_67_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_68_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_69_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_70_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_71_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_72_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_73_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_74_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_75_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_76_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_77_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_78_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_79_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_80_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_81_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_82_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_83_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_84_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_85_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_86_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_87_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_88_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_89_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_90_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_91_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_92_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_93_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_94_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_95_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_96_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_97_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_98_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_99_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_100_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_101_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_102_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_103_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_104_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_105_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_106_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_107_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_108_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_109_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_110_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_111_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_112_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_113_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_114_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_115_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_116_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_117_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_118_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_119_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_120_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_121_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_122_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_123_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_124_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_125_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_126_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_127_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_128_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_129_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_130_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_131_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_132_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_133_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_134_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_135_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_136_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_137_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_138_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_139_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_140_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_141_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_142_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_143_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_144_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_145_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const char ca_cert_146_data[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
const CACertInfo ca_certificates[CA_CERT_COUNT] PROGMEM = {
    {"ISRG Root X1", "isrg_root_x1.pem", ca_cert_00_data},
    {"ISRG Root X2", "isrg_root_x2.pem", ca_cert_01_data},
    {"Sectigo Public Server Authentication Root R46", "sectigo_public_server_authentication_root_r46.pem", ca_cert_02_data},
    {"Sectigo Public Server Authentication Root E46", "sectigo_public_server_authentication_root_e46.pem", ca_cert_03_data},
    {"COMODO RSA Certification Authority", "comodo_rsa_certification_authority.pem", ca_cert_04_data},
    {"USERTrust RSA Certification Authority", "usertrust_rsa_certification_authority.pem", ca_cert_05_data},
    {"USERTrust ECC Certification Authority", "usertrust_ecc_certification_authority.pem", ca_cert_06_data},
    {"DigiCert Global Root CA", "digicert_global_root_ca.pem", ca_cert_07_data},
    {"DigiCert Global Root G2", "digicert_global_root_g2.pem", ca_cert_08_data},
    {"DigiCert Global Root G3", "digicert_global_root_g3.pem", ca_cert_09_data},
    {"DigiCert High Assurance EV Root CA", "digicert_high_assurance_ev_root_ca.pem", ca_cert_10_data},
    {"DigiCert Assured ID Root CA", "digicert_assured_id_root_ca.pem", ca_cert_11_data},
    {"GlobalSign Root CA - R3", "globalsign_root_ca_r3.pem", ca_cert_12_data},
    {"GlobalSign Root CA - R3", "globalsign_root_ca_r3.pem", ca_cert_13_data},
    {"GlobalSign Root CA - R6", "globalsign_root_ca_r6.pem", ca_cert_14_data},
    {"GlobalSign ECC Root CA - R4", "globalsign_ecc_root_ca_r4.pem", ca_cert_15_data},
    {"GlobalSign ECC Root CA - R5", "globalsign_ecc_root_ca_r5.pem", ca_cert_16_data},
    {"Go Daddy Root Certificate Authority - G2", "go_daddy_root_certificate_authority_g2.pem", ca_cert_17_data},
    {"Starfield Root Certificate Authority - G2", "starfield_root_certificate_authority_g2.pem", ca_cert_18_data},
    {"Amazon Root CA 1", "amazon_root_ca_1.pem", ca_cert_19_data},
    {"Amazon Root CA 2", "amazon_root_ca_2.pem", ca_cert_20_data},
    {"Amazon Root CA 3", "amazon_root_ca_3.pem", ca_cert_21_data},
    {"Amazon Root CA 4", "amazon_root_ca_4.pem", ca_cert_22_data},
    {"GTS Root R1", "gts_root_r1.pem", ca_cert_23_data},
    {"GTS Root R2", "gts_root_r2.pem", ca_cert_24_data},
    {"GTS Root R3", "gts_root_r3.pem", ca_cert_25_data},
    {"GTS Root R4", "gts_root_r4.pem", ca_cert_26_data},
    {"Microsoft RSA Root Certificate Authority 2017", "microsoft_rsa_root_certificate_authority_2017.pem", ca_cert_27_data},
    {"Microsoft ECC Root Certificate Authority 2017", "microsoft_ecc_root_certificate_authority_2017.pem", ca_cert_28_data},
    {"IdenTrust Commercial Root CA 1", "identrust_commercial_root_ca_1.pem", ca_cert_29_data},
    {"IdenTrust Public Sector Root CA 1", "identrust_public_sector_root_ca_1.pem", ca_cert_30_data},
    {"Entrust Root Certification Authority", "entrust_root_certification_authority.pem", ca_cert_31_data},
    {"Entrust Root Certification Authority - G2", "entrust_root_certification_authority_g2.pem", ca_cert_32_data},
    {"Entrust Root Certification Authority - EC1", "entrust_root_certification_authority_ec1.pem", ca_cert_33_data},
    {"Certum Trusted Network CA", "certum_trusted_network_ca.pem", ca_cert_34_data},
    {"Certum Trusted Network CA 2", "certum_trusted_network_ca_2.pem", ca_cert_35_data},
    {"QuoVadis Root CA 2", "quovadis_root_ca_2.pem", ca_cert_36_data},
    {"QuoVadis Root CA 3", "quovadis_root_ca_3.pem", ca_cert_37_data},
    {"SwissSign Gold CA - G2", "swisssign_gold_ca_g2.pem", ca_cert_38_data},
    {"SecureTrust CA", "securetrust_ca.pem", ca_cert_39_data},
    {"Secure Global CA", "secure_global_ca.pem", ca_cert_40_data},
    {"COMODO Certification Authority", "comodo_certification_authority.pem", ca_cert_41_data},
    {"COMODO ECC Certification Authority", "comodo_ecc_certification_authority.pem", ca_cert_42_data},
    {"Certigna", "certigna.pem", ca_cert_43_data},
    {"ePKI Root Certification Authority", "epki_root_certification_authority.pem", ca_cert_44_data},
    {"certSIGN ROOT CA", "certsign_root_ca.pem", ca_cert_45_data},
    {"NetLock Arany (Class Gold) Főtanúsítvány", "netlock_arany_class_gold_főtanúsítvány.pem", ca_cert_46_data},
    {"Microsec e-Szigno Root CA 2009", "microsec_e_szigno_root_ca_2009.pem", ca_cert_47_data},
    {"Izenpe.com", "izenpecom.pem", ca_cert_48_data},
    {"Starfield Services Root Certificate Authority - G2", "starfield_services_root_certificate_authority_g2.pem", ca_cert_49_data},
    {"AffirmTrust Commercial", "affirmtrust_commercial.pem", ca_cert_50_data},
    {"AffirmTrust Networking", "affirmtrust_networking.pem", ca_cert_51_data},
    {"AffirmTrust Premium", "affirmtrust_premium.pem", ca_cert_52_data},
    {"AffirmTrust Premium ECC", "affirmtrust_premium_ecc.pem", ca_cert_53_data},
    {"TWCA Root Certification Authority", "twca_root_certification_authority.pem", ca_cert_54_data},
    {"Security Communication RootCA2", "security_communication_rootca2.pem", ca_cert_55_data},
    {"Actalis Authentication Root CA", "actalis_authentication_root_ca.pem", ca_cert_56_data},
    {"Buypass Class 2 Root CA", "buypass_class_2_root_ca.pem", ca_cert_57_data},
    {"Buypass Class 3 Root CA", "buypass_class_3_root_ca.pem", ca_cert_58_data},
    {"T-TeleSec GlobalRoot Class 3", "t_telesec_globalroot_class_3.pem", ca_cert_59_data},
    {"D-TRUST Root Class 3 CA 2 2009", "d_trust_root_class_3_ca_2_2009.pem", ca_cert_60_data},
    {"D-TRUST Root Class 3 CA 2 EV 2009", "d_trust_root_class_3_ca_2_ev_2009.pem", ca_cert_61_data},
    {"CA Disig Root R2", "ca_disig_root_r2.pem", ca_cert_62_data},
    {"ACCVRAIZ1", "accvraiz1.pem", ca_cert_63_data},
    {"TWCA Global Root CA", "twca_global_root_ca.pem", ca_cert_64_data},
    {"TeliaSonera Root CA v1", "teliasonera_root_ca_v1.pem", ca_cert_65_data},
    {"T-TeleSec GlobalRoot Class 2", "t_telesec_globalroot_class_2.pem", ca_cert_66_data},
    {"Atos TrustedRoot 2011", "atos_trustedroot_2011.pem", ca_cert_67_data},
    {"QuoVadis Root CA 1 G3", "quovadis_root_ca_1_g3.pem", ca_cert_68_data},
    {"QuoVadis Root CA 2 G3", "quovadis_root_ca_2_g3.pem", ca_cert_69_data},
    {"QuoVadis Root CA 3 G3", "quovadis_root_ca_3_g3.pem", ca_cert_70_data},
    {"DigiCert Assured ID Root G2", "digicert_assured_id_root_g2.pem", ca_cert_71_data},
    {"DigiCert Assured ID Root G3", "digicert_assured_id_root_g3.pem", ca_cert_72_data},
    {"DigiCert Trusted Root G4", "digicert_trusted_root_g4.pem", ca_cert_73_data},
    {"CFCA EV ROOT", "cfca_ev_root.pem", ca_cert_74_data},
    {"OISTE WISeKey Global Root GB CA", "oiste_wisekey_global_root_gb_ca.pem", ca_cert_75_data},
    {"SZAFIR ROOT CA2", "szafir_root_ca2.pem", ca_cert_76_data},
    {"Hellenic Academic and Research Institutions RootCA 2015", "hellenic_academic_and_research_institutions_rootca_2015.pem", ca_cert_77_data},
    {"Hellenic Academic and Research Institutions ECC RootCA 2015", "hellenic_academic_and_research_institutions_ecc_rootca_2015.pem", ca_cert_78_data},
    {"AC RAIZ FNMT-RCM", "ac_raiz_fnmt_rcm.pem", ca_cert_79_data},
    {"TUBITAK Kamu SM SSL Kok Sertifikasi - Surum 1", "tubitak_kamu_sm_ssl_kok_sertifikasi_surum_1.pem", ca_cert_80_data},
    {"GDCA TrustAUTH R5 ROOT", "gdca_trustauth_r5_root.pem", ca_cert_81_data},
    {"SSL.com Root Certification Authority RSA", "sslcom_root_certification_authority_rsa.pem", ca_cert_82_data},
    {"SSL.com Root Certification Authority ECC", "sslcom_root_certification_authority_ecc.pem", ca_cert_83_data},
    {"SSL.com EV Root Certification Authority RSA R2", "sslcom_ev_root_certification_authority_rsa_r2.pem", ca_cert_84_data},
    {"SSL.com EV Root Certification Authority ECC", "sslcom_ev_root_certification_authority_ecc.pem", ca_cert_85_data},
    {"OISTE WISeKey Global Root GC CA", "oiste_wisekey_global_root_gc_ca.pem", ca_cert_86_data},
    {"UCA Global G2 Root", "uca_global_g2_root.pem", ca_cert_87_data},
    {"UCA Extended Validation Root", "uca_extended_validation_root.pem", ca_cert_88_data},
    {"Certigna Root CA", "certigna_root_ca.pem", ca_cert_89_data},
    {"emSign Root CA - G1", "emsign_root_ca_g1.pem", ca_cert_90_data},
    {"emSign ECC Root CA - G3", "emsign_ecc_root_ca_g3.pem", ca_cert_91_data},
    {"emSign Root CA - C1", "emsign_root_ca_c1.pem", ca_cert_92_data},
    {"emSign ECC Root CA - C3", "emsign_ecc_root_ca_c3.pem", ca_cert_93_data},
    {"Hongkong Post Root CA 3", "hongkong_post_root_ca_3.pem", ca_cert_94_data},
    {"e-Szigno Root CA 2017", "e_szigno_root_ca_2017.pem", ca_cert_95_data},
    {"certSIGN Root CA G2", "certsign_root_ca_g2.pem", ca_cert_96_data},
    {"Trustwave Global Certification Authority", "trustwave_global_certification_authority.pem", ca_cert_97_data},
    {"Trustwave Global ECC P256 Certification Authority", "trustwave_global_ecc_p256_certification_authority.pem", ca_cert_98_data},
    {"Trustwave Global ECC P384 Certification Authority", "trustwave_global_ecc_p384_certification_authority.pem", ca_cert_99_data},
    {"NAVER Global Root Certification Authority", "naver_global_root_certification_authority.pem", ca_cert_100_data},
    {"AC RAIZ FNMT-RCM SERVIDORES SEGUROS", "ac_raiz_fnmt_rcm_servidores_seguros.pem", ca_cert_101_data},
    {"GlobalSign Root R46", "globalsign_root_r46.pem", ca_cert_102_data},
    {"GlobalSign Root E46", "globalsign_root_e46.pem", ca_cert_103_data},
    {"GLOBALTRUST 2020", "globaltrust_2020.pem", ca_cert_104_data},
    {"ANF Secure Server Root CA", "anf_secure_server_root_ca.pem", ca_cert_105_data},
    {"Certum EC-384 CA", "certum_ec_384_ca.pem", ca_cert_106_data},
    {"Certum Trusted Root CA", "certum_trusted_root_ca.pem", ca_cert_107_data},
    {"TunTrust Root CA", "tuntrust_root_ca.pem", ca_cert_108_data},
    {"HARICA TLS RSA Root CA 2021", "harica_tls_rsa_root_ca_2021.pem", ca_cert_109_data},
    {"HARICA TLS ECC Root CA 2021", "harica_tls_ecc_root_ca_2021.pem", ca_cert_110_data},
    {"Autoridad de Certificacion Firmaprofesional CIF A62634068", "autoridad_de_certificacion_firmaprofesional_cif_a62634068.pem", ca_cert_111_data},
    {"vTrus ECC Root CA", "vtrus_ecc_root_ca.pem", ca_cert_112_data},
    {"vTrus Root CA", "vtrus_root_ca.pem", ca_cert_113_data},
    {"HiPKI Root CA - G1", "hipki_root_ca_g1.pem", ca_cert_114_data},
    {"Telia Root CA v2", "telia_root_ca_v2.pem", ca_cert_115_data},
    {"D-TRUST BR Root CA 1 2020", "d_trust_br_root_ca_1_2020.pem", ca_cert_116_data},
    {"D-TRUST EV Root CA 1 2020", "d_trust_ev_root_ca_1_2020.pem", ca_cert_117_data},
    {"DigiCert TLS ECC P384 Root G5", "digicert_tls_ecc_p384_root_g5.pem", ca_cert_118_data},
    {"DigiCert TLS RSA4096 Root G5", "digicert_tls_rsa4096_root_g5.pem", ca_cert_119_data},
    {"Certainly Root R1", "certainly_root_r1.pem", ca_cert_120_data},
    {"Certainly Root E1", "certainly_root_e1.pem", ca_cert_121_data},
    {"Security Communication ECC RootCA1", "security_communication_ecc_rootca1.pem", ca_cert_122_data},
    {"BJCA Global Root CA1", "bjca_global_root_ca1.pem", ca_cert_123_data},
    {"BJCA Global Root CA2", "bjca_global_root_ca2.pem", ca_cert_124_data},
    {"SSL.com TLS RSA Root CA 2022", "sslcom_tls_rsa_root_ca_2022.pem", ca_cert_125_data},
    {"SSL.com TLS ECC Root CA 2022", "sslcom_tls_ecc_root_ca_2022.pem", ca_cert_126_data},
    {"Atos TrustedRoot Root CA ECC TLS 2021", "atos_trustedroot_root_ca_ecc_tls_2021.pem", ca_cert_127_data},
    {"Atos TrustedRoot Root CA RSA TLS 2021", "atos_trustedroot_root_ca_rsa_tls_2021.pem", ca_cert_128_data},
    {"TrustAsia Global Root CA G3", "trustasia_global_root_ca_g3.pem", ca_cert_129_data},
    {"TrustAsia Global Root CA G4", "trustasia_global_root_ca_g4.pem", ca_cert_130_data},
    {"CommScope Public Trust ECC Root-01", "commscope_public_trust_ecc_root_01.pem", ca_cert_131_data},
    {"CommScope Public Trust ECC Root-02", "commscope_public_trust_ecc_root_02.pem", ca_cert_132_data},
    {"CommScope Public Trust RSA Root-01", "commscope_public_trust_rsa_root_01.pem", ca_cert_133_data},
    {"CommScope Public Trust RSA Root-02", "commscope_public_trust_rsa_root_02.pem", ca_cert_134_data},
    {"Telekom Security TLS ECC Root 2020", "telekom_security_tls_ecc_root_2020.pem", ca_cert_135_data},
    {"Telekom Security TLS RSA Root 2023", "telekom_security_tls_rsa_root_2023.pem", ca_cert_136_data},
    {"FIRMAPROFESIONAL CA ROOT-A WEB", "firmaprofesional_ca_root_a_web.pem", ca_cert_137_data},
    {"TWCA CYBER Root CA", "twca_cyber_root_ca.pem", ca_cert_138_data},
    {"SecureSign Root CA12", "securesign_root_ca12.pem", ca_cert_139_data},
    {"SecureSign Root CA14", "securesign_root_ca14.pem", ca_cert_140_data},
    {"SecureSign Root CA15", "securesign_root_ca15.pem", ca_cert_141_data},
    {"D-TRUST BR Root CA 2 2023", "d_trust_br_root_ca_2_2023.pem", ca_cert_142_data},
    {"TrustAsia TLS ECC Root CA", "trustasia_tls_ecc_root_ca.pem", ca_cert_143_data},
    {"TrustAsia TLS RSA Root CA", "trustasia_tls_rsa_root_ca.pem", ca_cert_144_data},
    {"D-TRUST EV Root CA 2 2023", "d_trust_ev_root_ca_2_2023.pem", ca_cert_145_data},
    {"SwissSign RSA TLS Root CA 2022 - 1", "swisssign_rsa_tls_root_ca_2022_1.pem", ca_cert_146_data},
};