...
bool NFC::changeKey(uint8_t, uint8_t *, uint8_t *, uint8_t *)
{
    return false;
}

bool NFC::authenticate(uint8_t, uint8_t *)
{
    return false;
}
...
bool NFC::getAvailableKeyNo(uint8_t *, uint8_t *, uint8_t *)
{
    return false;
}
