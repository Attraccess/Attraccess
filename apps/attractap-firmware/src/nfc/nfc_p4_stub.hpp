...
/**
 * NFC stub for ESP32-P4: mbedtls/NTAG424 compatibility issues with P4 framework.
 * Provides same interface as NFC but does nothing; card detection never fires.
 */
class NFC
{
public:
