...
void Display::showErrorPopup(const String &title, const String &message) {
  ...
  lv_obj_set_style_bg_color(okBtn, lv_color_hex(0xF31260),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
...
void Display::showInsufficientBalancePopup(
  ...
  // Message
  lv_obj_t *msgLbl = lv_label_create(dialog);
  lv_label_set_text(msgLbl, "Ihr Guthaben reicht nicht aus, um die Aktion "
                            "auszuführen. Bitte laden Sie Ihr Guthaben auf.");
  lv_obj_set_style_text_color(msgLbl, lv_color_hex(0xFFFFFF),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(msgLbl, &lv_font_montserrat_14,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_color(amountLbl, lv_color_hex(0xFFFFFF),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(amountLbl, &lv_font_montserrat_14,
                             LV_PART_MAIN | LV_STATE_DEFAULT);

  // Amount input
  lv_obj_t *amountTa = lv_textarea_create(dialog);
  lv_textarea_set_one_line(amountTa, true);
  lv_textarea_set_max_length(amountTa, 6);
  lv_textarea_set_accepted_chars(amountTa, "0123456789");
  lv_obj_set_width(amountTa, lv_pct(100));
  lv_obj_set_style_bg_color(amountTa, lv_color_hex(0x3A3A3A),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_color(amountTa, lv_color_hex(0xFFFFFF),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_color(errorLbl, lv_color_hex(0xF31260),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(errorLbl, &lv_font_montserrat_14,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  InsufficientBalancePopupCtx *ctx = new InsufficientBalancePopupCtx{
      onStart, onCancel, dialog, amountTa, errorLbl, nullptr};
  lv_obj_add_event_cb(
      overlay,
      [](lv_event_t *e) {
  ...
  lv_obj_set_style_bg_color(cancelBtn, lv_color_hex(0x6B7280),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_bg_color(startBtn, lv_color_hex(0x10B981),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_add_event_cb(
      ...
      [](lv_event_t *e) {
        ...
        if (c->keyboard)
          lv_obj_add_flag(c->keyboard, LV_OBJ_FLAG_HIDDEN);

        lv_obj_t *footer =
            lv_obj_get_parent((lv_obj_t *)lv_event_get_target(e));
        ...
        lv_obj_set_style_text_color(infoLbl, lv_color_hex(0xFFFFFF),
                                    LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_text_font(infoLbl, &lv_font_montserrat_14,
                                   LV_PART_MAIN | LV_STATE_DEFAULT);

        if (c->onStart)
          c->onStart(amountCents);
        Display::popupAutoCloseTimer = lv_timer_create(
            [](lv_timer_t *tmr) {
              (void)tmr;
              Display::hidePopup();
              Display::popupAutoCloseTimer = nullptr;
            ...
            1200, NULL);
        (void)Display::popupAutoCloseTimer;
      },
      LV_EVENT_CLICKED, ctx);
