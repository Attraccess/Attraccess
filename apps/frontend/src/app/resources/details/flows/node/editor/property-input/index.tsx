...
interface PropertyViewProps<TValue> extends Props<TValue> {
  label: string;
  description: React.ReactNode;
}

function propertyDescription<TValue>(props: Props<TValue>): React.ReactNode {
...
function StringPropertyInput<TValue>(props: PropertyViewProps<TValue> & { enumLabel: (item: EnumValue) => string }) {
...
function NumberPropertyInput<TValue>(
...
function ObjectPropertyInput<TValue>(props: PropertyViewProps<TValue>) {
  const {
    name,
    nodeType,
    schema,
...
function ArrayPropertyInput<TValue>(props: PropertyViewProps<TValue>) {
...
function BooleanPropertyInput<TValue>(props: PropertyViewProps<TValue>) {
...
function MqttPropertyInput<TValue>(props: PropertyViewProps<TValue>) {
