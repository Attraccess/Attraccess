      ...
      <ModalContent>
        ...
        <ModalBody>
          {diff.length === 0 ? (
            ...
            <Table removeWrapper aria-label="changes" data-testid="policy-diff-table">
              <TableHeader>
                <TableColumn>{t('diff.field')}</TableColumn>
              ...
              <TableBody>
                {diff.map((row) => (
                  <TableRow key={row.field}>
                    ...
                    <TableCell><code>{row.before}</code></TableCell>
                    <TableCell><code className="text-success-600">{row.after}</code></TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
