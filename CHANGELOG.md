...
- adopt white RAL 5021 branding across the apps ([#1816](https://github.com/Attraccess/Attraccess/pull/1816))
- organize personal account settings with reusable directory ([#1871](https://github.com/Attraccess/Attraccess/pull/1871))
- **ATT-1024:** add operating-timeline verification and operational observability ([#1860](https://github.com/Attraccess/Attraccess/pull/1860))
- **ATT-1025:** derive operating session attribution ([#1773](https://github.com/Attraccess/Attraccess/pull/1773))
- **ATT-1026:** apply operating duration to billing and maintenance ([#1777](https://github.com/Attraccess/Attraccess/pull/1777))
- **ATT-1027:** expose operating duration reporting ([#1799](https://github.com/Attraccess/Attraccess/pull/1799))
- **ATT-1028:** add operating timeline flows ([#1757](https://github.com/Attraccess/Attraccess/pull/1757))
- **ATT-1041:** add CC100 Docker runtime ([#1779](https://github.com/Attraccess/Attraccess/pull/1779))
- **ATT-1047:** improve plugin marketplace UI ([#1794](https://github.com/Attraccess/Attraccess/pull/1794))
- **ATT-1048:** add runnable CC100 simulator ([#1797](https://github.com/Attraccess/Attraccess/pull/1797))
- **ATT-1051:** complete CC100 MQTT enrollment ([#1791](https://github.com/Attraccess/Attraccess/pull/1791))
- **ATT-1052:** secure CC100 commissioning ([#1793](https://github.com/Attraccess/Attraccess/pull/1793))
- **ATT-1053:** reorganize flow node catalog ([#1795](https://github.com/Attraccess/Attraccess/pull/1795))
- **ATT-1056:** implement CC100 packed digital I/O ([#1803](https://github.com/Attraccess/Attraccess/pull/1803))
- **ATT-1057:** use private CA trust for broker management ([#1804](https://github.com/Attraccess/Attraccess/pull/1804))
- **ATT-1057:** add recoverable CC100 runtime installation ([#1807](https://github.com/Attraccess/Attraccess/pull/1807))
- **ATT-1057:** import signed CC100 runtime releases ([f5ffa7b6](https://github.com/Attraccess/Attraccess/commit/f5ffa7b6))
- **ATT-1057:** add recoverable management security transitions ([#1815](https://github.com/Attraccess/Attraccess/pull/1815))
- **ATT-1057:** connect the no-code commissioning workflow ([#1817](https://github.com/Attraccess/Attraccess/pull/1817))
- **ATT-1057:** complete live CC100 commissioning prerequisites ([#1823](https://github.com/Attraccess/Attraccess/pull/1823))
- **ATT-1058:** visual WAGO digital configuration and lifecycle ([#1812](https://github.com/Attraccess/Attraccess/pull/1812))
- **ATT-1059:** add configurable Modbus transports and visual profiles ([#1811](https://github.com/Attraccess/Attraccess/pull/1811))
- **ATT-497:** Shelly auto-discovery via mDNS + subnet scan ([#1585](https://github.com/Attraccess/Attraccess/pull/1585))
- **ATT-498:** add Shelly device info UI ([#1352](https://github.com/Attraccess/Attraccess/pull/1352), [#1312](https://github.com/Attraccess/Attraccess/issues/1312))
- **ATT-501:** Shelly firmware updates for Gen1 and Gen2+ ([#1586](https://github.com/Attraccess/Attraccess/pull/1586))
- **ATT-580:** cache canControllResource() authorization results with 30s TTL ([#1415](https://github.com/Attraccess/Attraccess/pull/1415))
- **ATT-778:** allow plugins to register custom flow nodes ([#1592](https://github.com/Attraccess/Attraccess/pull/1592))
- **ATT-795:** give plugins a preconfigured API client ([#1591](https://github.com/Attraccess/Attraccess/pull/1591))
- **ATT-800:** add MQTT plugin subscriptions ([#1759](https://github.com/Attraccess/Attraccess/pull/1759))
- **ATT-801:** let plugins trigger flows ([#1755](https://github.com/Attraccess/Attraccess/pull/1755))
- **ATT-808:** support dynamic plugin flow schemas ([#1754](https://github.com/Attraccess/Attraccess/pull/1754))
- **ATT-812:** manage npm plugin lifecycle state ([#1761](https://github.com/Attraccess/Attraccess/pull/1761))
- **ATT-813:** add plugin version policy controls ([#1766](https://github.com/Attraccess/Attraccess/pull/1766))
- **ATT-818:** add resource plugin slots ([#1756](https://github.com/Attraccess/Attraccess/pull/1756))
- **ATT-972:** add flow failure policies ([#1748](https://github.com/Attraccess/Attraccess/pull/1748))
- **ATT-973:** compose WAGO commissioning, durable audit and fleet acceptance ([#1813](https://github.com/Attraccess/Attraccess/pull/1813))
- **ATT-974:** add broker credential provisioning providers ([#1753](https://github.com/Attraccess/Attraccess/pull/1753))
- **ATT-975:** add WAGO controller discovery ([#1765](https://github.com/Attraccess/Attraccess/pull/1765))
- **ATT-976:** publish WAGO configuration revisions ([#1772](https://github.com/Attraccess/Attraccess/pull/1772))
- **ATT-977:** add declarative WAGO presets ([#1781](https://github.com/Attraccess/Attraccess/pull/1781))
- **ATT-978:** react to WAGO state and events in flows ([34761165](https://github.com/Attraccess/Attraccess/commit/34761165))
- **ATT-979:** define WAGO meter measurements ([#1796](https://github.com/Attraccess/Attraccess/pull/1796))
- **ATT-980:** control WAGO logical channels from flows ([#1789](https://github.com/Attraccess/Attraccess/pull/1789))
- **ATT-981:** add bounded WAGO controller diagnostics ([#1809](https://github.com/Attraccess/Attraccess/pull/1809))
- **ATT-983:** add redacted WAGO audit integration ([#1802](https://github.com/Attraccess/Attraccess/pull/1802))
- **ATT-991:** publish official plugins to npm ([#1752](https://github.com/Attraccess/Attraccess/pull/1752))
- **ATT-992:** add plugin marketplace UI ([#1762](https://github.com/Attraccess/Attraccess/pull/1762))
- **ATT-993:** classify official plugins ([#1760](https://github.com/Attraccess/Attraccess/pull/1760))
- **ATT-994:** manage installed npm plugin versions ([#1758](https://github.com/Attraccess/Attraccess/pull/1758))
- **ATT-995:** add npm plugin installer backend ([#1749](https://github.com/Attraccess/Attraccess/pull/1749))
- **api:** audit maintenance and supervision decisions ([#1829](https://github.com/Attraccess/Attraccess/pull/1829))
- **attractap:** power off button on all touch v2 targets ([#1668](https://github.com/Attraccess/Attraccess/pull/1668))
- **attractap:** migrate firmware to ESP-IDF v6.0.2 ([#1691](https://github.com/Attraccess/Attraccess/pull/1691), [#1696](https://github.com/Attraccess/Attraccess/issues/1696))
- **attractap:** surface reader network quality ([#1349](https://github.com/Attraccess/Attraccess/pull/1349))
- **attractap:** run production workflows on desktop ([#1835](https://github.com/Attraccess/Attraccess/pull/1835), [#1824](https://github.com/Attraccess/Attraccess/issues/1824), [#1826](https://github.com/Attraccess/Attraccess/issues/1826), [#1832](https://github.com/Attraccess/Attraccess/issues/1832))
- **attractap:** keep authenticated resource actions in list (ATT-880) ([#1865](https://github.com/Attraccess/Attraccess/pull/1865))
- **attractap:** ship macOS simulator downloads ([#1876](https://github.com/Attraccess/Attraccess/pull/1876))
- **audit:** record billing transaction activity (ATT-916) ([#1830](https://github.com/Attraccess/Attraccess/pull/1830))
- **audit:** record administration and plugin lifecycle activity (ATT-917) ([#1849](https://github.com/Attraccess/Attraccess/pull/1849))
- **audit:** record identity, SSO, resource, and Attractap activity (ATT-913) ([#1846](https://github.com/Attraccess/Attraccess/pull/1846), [#1850](https://github.com/Attraccess/Attraccess/issues/1850), [#1854](https://github.com/Attraccess/Attraccess/issues/1854), [#1853](https://github.com/Attraccess/Attraccess/issues/1853), [#1852](https://github.com/Attraccess/Attraccess/issues/1852))
- **audit:** record project administration (ATT-912) ([#1851](https://github.com/Attraccess/Attraccess/pull/1851), [#1850](https://github.com/Attraccess/Attraccess/issues/1850), [#1854](https://github.com/Attraccess/Attraccess/issues/1854), [#1853](https://github.com/Attraccess/Attraccess/issues/1853), [#1852](https://github.com/Attraccess/Attraccess/issues/1852))
- **auth:** passkey (WebAuthn) sign-in and management ([#1587](https://github.com/Attraccess/Attraccess/pull/1587))
- **dev:** add local database seeding skills ([#1733](https://github.com/Attraccess/Attraccess/pull/1733))
- **forms:** add drag-and-drop field reordering ([#1676](https://github.com/Attraccess/Attraccess/pull/1676))
- **frontend:** add audit log settings interface (ATT-907) ([#1828](https://github.com/Attraccess/Attraccess/pull/1828))
- **frontend:** add resource settings page and streamlined creation ([#1875](https://github.com/Attraccess/Attraccess/pull/1875))
- **mqtt:** add TLS trust options for brokers with self-signed certs ([#1588](https://github.com/Attraccess/Attraccess/pull/1588))
- **plugins:** surface marketplace updates ([#1864](https://github.com/Attraccess/Attraccess/pull/1864))
- **printables:** add 3D models page with configurable NFC keychain card ([#1669](https://github.com/Attraccess/Attraccess/pull/1669), [#1658](https://github.com/Attraccess/Attraccess/issues/1658), [#0](https://github.com/Attraccess/Attraccess/issues/0))
- **settings:** shell, layout primitives, General + Monitoring (ATT-864) ([#1681](https://github.com/Attraccess/Attraccess/pull/1681))
- **settings:** remaining sections — Security, Roles, SSO, Email, Messaging, Plugins, About (ATT-865) ([#1683](https://github.com/Attraccess/Attraccess/pull/1683))
- **settings:** sidebar restructure, old route removal, link updates (ATT-866) ([#1684](https://github.com/Attraccess/Attraccess/pull/1684))
- **settings:** use account-style directory for global settings ([#1874](https://github.com/Attraccess/Attraccess/pull/1874))
- **supervision:** let the requester send the approval to an NFC reader ([#1660](https://github.com/Attraccess/Attraccess/pull/1660))
- **tooling:** add JS/TS CRAP score reports ([#1866](https://github.com/Attraccess/Attraccess/pull/1866))
- **wago:** improve configuration workspace and resource flow integration ([#1844](https://github.com/Attraccess/Attraccess/pull/1844))

### 🩹 Fixes

- align .nvmrc and root Dockerfile with node:24.18.0 used elsewhere ([#1595](https://github.com/Attraccess/Attraccess/pull/1595), [#1581](https://github.com/Attraccess/Attraccess/issues/1581))
- correct license field to match LICENSE.md ([#1630](https://github.com/Attraccess/Attraccess/pull/1630))
- stop wrapping forms in Cards (HeroUI v3 idiom), add a cross-file regression guard (ATT-834) ([#1673](https://github.com/Attraccess/Attraccess/pull/1673))
- quarantine plugins after startup failures ([#1782](https://github.com/Attraccess/Attraccess/pull/1782))
- encode scoped plugin asset URLs ([#1792](https://github.com/Attraccess/Attraccess/pull/1792))
- repair marketplace plugin installs and compact confirmation ([#1870](https://github.com/Attraccess/Attraccess/pull/1870))
- **ATT-1029:** reset cancelled resource form drafts ([#1776](https://github.com/Attraccess/Attraccess/pull/1776))
- **ATT-1030:** avoid fullscreen form loaders ([#1774](https://github.com/Attraccess/Attraccess/pull/1774))
- **ATT-1046:** mark official plugins as alpha ([#1783](https://github.com/Attraccess/Attraccess/pull/1783))
- **ATT-1057:** require explicit commissioning authorization ([#1801](https://github.com/Attraccess/Attraccess/pull/1801))
- **ATT-1058:** make dynamic WAGO command forms safe to save ([#1808](https://github.com/Attraccess/Attraccess/pull/1808))
- **ATT-1067:** render German umlauts on Attractap ([#1827](https://github.com/Attraccess/Attraccess/pull/1827))
- **ATT-1070:** add marketplace close button ([#1840](https://github.com/Attraccess/Attraccess/pull/1840))
- **ATT-1071:** retry failed plugin loads ([#1841](https://github.com/Attraccess/Attraccess/pull/1841))
- **ATT-1072:** restore Attractap dark theme and background artwork ([#1842](https://github.com/Attraccess/Attraccess/pull/1842))
- **ATT-644:** show descriptions for non-configurable flow nodes ([#1770](https://github.com/Attraccess/Attraccess/pull/1770))
- **ATT-741:** confirm email changes before verification reset ([#1740](https://github.com/Attraccess/Attraccess/pull/1740))
- **ATT-746:** translate RBAC permission catalog and system role names ([#1672](https://github.com/Attraccess/Attraccess/pull/1672))
- **ATT-754:** finalize usage before stop flows ([#1743](https://github.com/Attraccess/Attraccess/pull/1743))
- **ATT-756:** attribute introductions to actor ([#1741](https://github.com/Attraccess/Attraccess/pull/1741))
- **ATT-760:** align delete role radio options ([#1742](https://github.com/Attraccess/Attraccess/pull/1742))
- **ATT-783:** report missing SMTP configuration ([#1732](https://github.com/Attraccess/Attraccess/pull/1732))
- **ATT-784:** set production Node environment ([#1769](https://github.com/Attraccess/Attraccess/pull/1769))
- **ATT-786:** suppress idle WiFi log chatter ([#1745](https://github.com/Attraccess/Attraccess/pull/1745))
- **ATT-790:** evaluate flow if-node relational operators in the order they read ([#1589](https://github.com/Attraccess/Attraccess/pull/1589))
- **ATT-792:** show large flows in the editor instead of an empty canvas ([#1590](https://github.com/Attraccess/Attraccess/pull/1590))
- **ATT-832:** make role counts actionable ([#1736](https://github.com/Attraccess/Attraccess/pull/1736))
- **ATT-832:** use drawer for mobile filters ([#1746](https://github.com/Attraccess/Attraccess/pull/1746))
- **ATT-835:** expose email to current user ([#1771](https://github.com/Attraccess/Attraccess/pull/1771))
- **ATT-845:** audit verification email outages ([#1739](https://github.com/Attraccess/Attraccess/pull/1739))
- **ATT-859:** resolve card guard resolution gaps ([#1763](https://github.com/Attraccess/Attraccess/pull/1763))
- **ATT-873:** show 404 to logged-out visitors ([#1744](https://github.com/Attraccess/Attraccess/pull/1744))
- **ATT-958:** embed email logo inline ([#1747](https://github.com/Attraccess/Attraccess/pull/1747))
- **ATT-978:** consume input state with canonical freshness and boot streams ([#1805](https://github.com/Attraccess/Attraccess/pull/1805))
- **ATT-984:** unblock WAGO plugin startup and validation ([#1822](https://github.com/Attraccess/Attraccess/pull/1822))
- **api:** limit user list details by permission (ATT-837) ([#1713](https://github.com/Attraccess/Attraccess/pull/1713))
- **api:** contain usage-start flow failures ([#1712](https://github.com/Attraccess/Attraccess/pull/1712))
- **api:** make account deletion confirmation idempotent ([#1715](https://github.com/Attraccess/Attraccess/pull/1715))
- **api:** detach maintenances before schedule deletion (ATT-769) ([#1750](https://github.com/Attraccess/Attraccess/pull/1750))
- **api:** defer plugin repository resolution during bootstrap ([#1873](https://github.com/Attraccess/Attraccess/pull/1873))
- **attractap:** stop the supervision screen cancelling itself, say Aufsicht not Tutor (ATT-867) ([#1682](https://github.com/Attraccess/Attraccess/pull/1682))
- **attractap:** ignore intentional software resets ([#1728](https://github.com/Attraccess/Attraccess/pull/1728))
- **attractap:** include all resource introducers ([#1711](https://github.com/Attraccess/Attraccess/pull/1711))
- **attractap:** improve reader descriptions and network badge ([#1877](https://github.com/Attraccess/Attraccess/pull/1877))
- **audit:** restore usable activity inspection and controls (ATT-907) ([#1848](https://github.com/Attraccess/Attraccess/pull/1848))
- **billing:** read SumUp merchant code from merchant_profile ([#1635](https://github.com/Attraccess/Attraccess/pull/1635))
- **ci:** make docker cache export non-fatal and fix latest-tag condition ([#1541](https://github.com/Attraccess/Attraccess/pull/1541))
- **ci:** publish official plugins to npm ([#1775](https://github.com/Attraccess/Attraccess/pull/1775))
- **ci:** recreate plugin archive directory ([#1778](https://github.com/Attraccess/Attraccess/pull/1778))
- **ci:** publish plugins only when affected ([#1784](https://github.com/Attraccess/Attraccess/pull/1784))
- **ci:** restore nightly WAGO build contracts ([#1834](https://github.com/Attraccess/Attraccess/pull/1834))
- **companion:** replace keytar with electron safeStorage ([#1686](https://github.com/Attraccess/Attraccess/pull/1686))
- **config-ui:** restart dnsmasq after unexpected exit ([#1661](https://github.com/Attraccess/Attraccess/pull/1661))
- **deps:** update nx monorepo to v22.7.7 ([#1556](https://github.com/Attraccess/Attraccess/pull/1556))
- **deps:** update dependency express to v4.22.2 ([#1554](https://github.com/Attraccess/Attraccess/pull/1554))
- **deps:** update react monorepo to v19.2.8 ([#1557](https://github.com/Attraccess/Attraccess/pull/1557))
- **deps:** update dependency react-router-dom to v7.18.2 ([#1579](https://github.com/Attraccess/Attraccess/pull/1579))
- **deps:** update dependency playwright to v1.62.0 ([#1582](https://github.com/Attraccess/Attraccess/pull/1582))
- **deps:** update nx monorepo to v22.7.8 ([#1614](https://github.com/Attraccess/Attraccess/pull/1614))
- **deps:** update dependency playwright to v1.62.1 ([#1613](https://github.com/Attraccess/Attraccess/pull/1613))
- **deps:** update dependency @internationalized/date to v3.12.3 ([#1612](https://github.com/Attraccess/Attraccess/pull/1612))
- **deps:** repair pnpm-lock.yaml entry for acorn ([#1655](https://github.com/Attraccess/Attraccess/pull/1655))
- **dev:** bootstrap new worktree dependencies ([#1751](https://github.com/Attraccess/Attraccess/pull/1751))
- **docker:** strip swc-node patch by name, not pinned version ([#1632](https://github.com/Attraccess/Attraccess/pull/1632), [#1563](https://github.com/Attraccess/Attraccess/issues/1563))
- **docker:** pin config-ui and hetzner-dns-updater to nvmrc node version ([#1664](https://github.com/Attraccess/Attraccess/pull/1664), [#1658](https://github.com/Attraccess/Attraccess/issues/1658))
- **flows:** log descriptive node failures ([#1726](https://github.com/Attraccess/Attraccess/pull/1726))
- **flows:** document JSON payload templates ([#1738](https://github.com/Attraccess/Attraccess/pull/1738))
- **frontend:** keep chat composer above the mobile keyboard (ATT-788) ([#1549](https://github.com/Attraccess/Attraccess/pull/1549))
- **frontend:** reset hide-empty-groups on clear filter and search ([#1576](https://github.com/Attraccess/Attraccess/pull/1576))
- **frontend:** remove duplicated invite-skipping-failed-rows button ([#1577](https://github.com/Attraccess/Attraccess/pull/1577))
- **frontend:** add visible label to project description field ([#1575](https://github.com/Attraccess/Attraccess/pull/1575))
- **frontend:** add accessible names to pagination prev/next buttons ([#1578](https://github.com/Attraccess/Attraccess/pull/1578))
- **frontend:** open supervisor picker on supervision_required resources ([#1654](https://github.com/Attraccess/Attraccess/pull/1654))
- **frontend:** make documentation type radios selectable (ATT-734) ([#1671](https://github.com/Attraccess/Attraccess/pull/1671))
- **frontend:** address UI feedback round (tabs, overflow, alignment, emails) ([#1679](https://github.com/Attraccess/Attraccess/pull/1679), [#1676](https://github.com/Attraccess/Attraccess/issues/1676))
- **frontend:** render a not-found page instead of a blank document (ATT-869) ([#1685](https://github.com/Attraccess/Attraccess/pull/1685))
- **frontend:** anchor CSV import error badge ([#1704](https://github.com/Attraccess/Attraccess/pull/1704))
- **frontend:** make login page scrollable on mobile ([#1707](https://github.com/Attraccess/Attraccess/pull/1707))
- **frontend:** prevent transient introduction warning ([#1709](https://github.com/Attraccess/Attraccess/pull/1709))
- **frontend:** hide empty password hints (ATT-898) ([#1710](https://github.com/Attraccess/Attraccess/pull/1710))
- **frontend:** localize invalid CSV upload errors (ATT-749) ([#1729](https://github.com/Attraccess/Attraccess/pull/1729))
- **frontend:** close permission picker on Escape ([#1730](https://github.com/Attraccess/Attraccess/pull/1730))
- **frontend:** refresh role rows on language change ([#1725](https://github.com/Attraccess/Attraccess/pull/1725))
- **frontend:** polish RAL 5021 UI spacing ([#1839](https://github.com/Attraccess/Attraccess/pull/1839))
- **frontend:** complete operating-duration setup and first-use UX ([#1863](https://github.com/Attraccess/Attraccess/pull/1863))
- **plugins:** load marketplace plugins across bootstrap phases ([#1872](https://github.com/Attraccess/Attraccess/pull/1872))
- **resources:** preserve introducer and maintainer roles ([#1714](https://github.com/Attraccess/Attraccess/pull/1714))
- **resources:** restrict supervision to introducers ([#1720](https://github.com/Attraccess/Attraccess/pull/1720))
- **resources:** correct operating-duration accounting and lifecycle persistence ([#1861](https://github.com/Attraccess/Attraccess/pull/1861))
- **settings:** complete unauthenticated SMTP setup ([#1731](https://github.com/Attraccess/Attraccess/pull/1731))
- **tooling:** correct CRAP report locations and threshold (ATT-1088) ([#1867](https://github.com/Attraccess/Attraccess/pull/1867))

### 🔥 Performance

- make firmware toolchain opt-in ([#1767](https://github.com/Attraccess/Attraccess/pull/1767))
- **ATT-579:** batch DB queries and debounce resource list broadcasts ([#1416](https://github.com/Attraccess/Attraccess/pull/1416))
- **ATT-582:** batch maintenance schedule evaluation to avoid O(n) transactions ([#1417](https://github.com/Attraccess/Attraccess/pull/1417))
- **ATT-794:** record flow logs in memory on demand instead of writing every line to SQLite ([#1605](https://github.com/Attraccess/Attraccess/pull/1605))
- **attractap:** network quick wins — disable wifi modem sleep, ws network_timeout 5s, tx task prio below render ([#1692](https://github.com/Attraccess/Attraccess/pull/1692))
- **attractap:** NFC polling — detection poll 30ms, waitready 2ms granularity, presence-auth throttle 250ms ([#1693](https://github.com/Attraccess/Attraccess/pull/1693))
- **attractap:** hardware-verified fluid rendering at 42Hz with 10ms touch ([#1694](https://github.com/Attraccess/Attraccess/pull/1694))
- **attractap:** non-blocking beeper via esp_timer (no 100-700ms UI freeze under lv_lock) ([#1695](https://github.com/Attraccess/Attraccess/pull/1695))
- **attractap:** single-instance image arrays via C++17 inline (~2.2MB flash) + lockscreen re-encoded RGB565 ([#1696](https://github.com/Attraccess/Attraccess/pull/1696), [#1691](https://github.com/Attraccess/Attraccess/issues/1691))
...
- Jan Jaap @jappyjan
- Marcel Verdult @marcelverdult

## 1.9.0 (2026-07-25)

### 🚀 Features

- **ATT-130:** full-page GrapesJS WYSIWYG editor for email templates with integrated translations ([#1482](https://github.com/Attraccess/Attraccess/pull/1482))
- **ATT-22:** version info and system metrics on admin settings page ([#1463](https://github.com/Attraccess/Attraccess/pull/1463))
- **ATT-563:** RBAC data model, default roles, and migration ([#1420](https://github.com/Attraccess/Attraccess/pull/1420))
- **ATT-564:** SSO role mappings and login sync ([#1516](https://github.com/Attraccess/Attraccess/pull/1516))
- **ATT-565:** user management roles API and UI ([#1510](https://github.com/Attraccess/Attraccess/pull/1510))
- **ATT-566:** RBAC effective-permission resolver, backend guard integration, and frontend migration ([#1470](https://github.com/Attraccess/Attraccess/pull/1470))
- **ATT-574:** refactor email templates into global layout and content sections ([#1387](https://github.com/Attraccess/Attraccess/pull/1387))
- **ATT-583:** add pagination to analytics resource usage endpoints ([#1468](https://github.com/Attraccess/Attraccess/pull/1468))
- **ATT-605:** Electron companion app scaffold ([#1444](https://github.com/Attraccess/Attraccess/pull/1444))
- **ATT-606:** companion device self-registration and WebSocket gateway ([#1441](https://github.com/Attraccess/Attraccess/pull/1441))
- **ATT-609:** companion app lockscreen & input blocking — Windows ([#1456](https://github.com/Attraccess/Attraccess/pull/1456))
- **ATT-610:** kiosk-mode frontend routes for companion app lockscreen webview ([#1451](https://github.com/Attraccess/Attraccess/pull/1451))
- **ATT-611:** companion app lockscreen & input blocking — Linux (X11 + Wayland) ([#1458](https://github.com/Attraccess/Attraccess/pull/1458))
- **ATT-612:** companion idle/active flow trigger nodes ([#1457](https://github.com/Attraccess/Attraccess/pull/1457))
- **ATT-614:** companion app binary download endpoint ([#1452](https://github.com/Attraccess/Attraccess/pull/1452))
- **ATT-615:** companion app settings page — device management, downloads, setup guide ([#1454](https://github.com/Attraccess/Attraccess/pull/1454))
- **ATT-620:** Lock PC and Unlock PC flow output nodes ([#1443](https://github.com/Attraccess/Attraccess/pull/1443))
- **ATT-621:** companion app — API WebSocket gateway and Electron client with first-run wizard ([#1442](https://github.com/Attraccess/Attraccess/pull/1442))
- **ATT-623:** companion WebSocket AsyncAPI spec + auto-generated TypeScript client ([#1449](https://github.com/Attraccess/Attraccess/pull/1449))
- **ATT-625:** shared UI library — HeroUI v3 + Tailwind CSS v4 + React companion wizard ([#1448](https://github.com/Attraccess/Attraccess/pull/1448))
- **ATT-626:** macOS lockscreen & input blocking for companion app ([#1450](https://github.com/Attraccess/Attraccess/pull/1450), [#1453](https://github.com/Attraccess/Attraccess/issues/1453))
- **ATT-628:** track companion app version per device ([#1461](https://github.com/Attraccess/Attraccess/pull/1461))
- **ATT-629:** replace polling with SSE-triggered refetch for resource usage session ([#1455](https://github.com/Attraccess/Attraccess/pull/1455))
- **ATT-630:** manage registered companion devices — rename in drawer ([#1462](https://github.com/Attraccess/Attraccess/pull/1462))
- **ATT-631:** companion app OS adapter layer for system metrics ([#1465](https://github.com/Attraccess/Attraccess/pull/1465))
- **ATT-632:** companion app foreground app flow trigger ([#1479](https://github.com/Attraccess/Attraccess/pull/1479))
- **ATT-633:** companion app USB device connect/disconnect flow triggers ([#1507](https://github.com/Attraccess/Attraccess/pull/1507))
- **ATT-634:** companion app auto-update devices from the server ([#1467](https://github.com/Attraccess/Attraccess/pull/1467), [#1501](https://github.com/Attraccess/Attraccess/issues/1501))
- **ATT-635:** split and restructure settings into contextual pages ([#1469](https://github.com/Attraccess/Attraccess/pull/1469))
- **ATT-636:** persist user locale preference ([#1464](https://github.com/Attraccess/Attraccess/pull/1464))
- **ATT-637:** {{t}} Handlebars helper for email templates with DB-backed translations ([#1478](https://github.com/Attraccess/Attraccess/pull/1478))
- **ATT-643:** extract email templates/layout defaults to bundled files and add reset functionality ([#1475](https://github.com/Attraccess/Attraccess/pull/1475))
- **ATT-647:** add toggle-all controls to notification settings ([#1484](https://github.com/Attraccess/Attraccess/pull/1484))
- **ATT-716:** per-reader Prometheus metrics and Grafana deep-dive dashboard ([#1504](https://github.com/Attraccess/Attraccess/pull/1504))
- **ATT-721:** loading states for flow editor ([#1500](https://github.com/Attraccess/Attraccess/pull/1500))
- **ATT-724:** translate push/toast notification titles and bodies to user locale ([#1506](https://github.com/Attraccess/Attraccess/pull/1506))
- **ATT-726:** Attractap demo firmware target ([#1508](https://github.com/Attraccess/Attraccess/pull/1508))
- **ATT-728:** role management API and UI ([#1514](https://github.com/Attraccess/Attraccess/pull/1514))
- **attractap:** power-off button in touch-v2 demo settings ([#1535](https://github.com/Attraccess/Attraccess/pull/1535))
- **users:** replace user picker with address-book modal ([#1499](https://github.com/Attraccess/Attraccess/pull/1499))

### 🩹 Fixes

- balena compose depends_on (short-form) so balena push succeeds ([#1440](https://github.com/Attraccess/Attraccess/pull/1440))
- update node-version-consistency spec for docker-build-push composite action ([#1517](https://github.com/Attraccess/Attraccess/pull/1517))
- **ATT-436:** generate fresh IDs when importing a flow ([#1481](https://github.com/Attraccess/Attraccess/pull/1481))
- **ATT-534:** route-shadow guard mishandles multiple controllers per file ([#1459](https://github.com/Attraccess/Attraccess/pull/1459))
- **ATT-581:** prune SSE resource subjects when no subscribers remain ([#1466](https://github.com/Attraccess/Attraccess/pull/1466))
- **ATT-598:** add DB index and skip SSE from HTTP duration metrics ([#1436](https://github.com/Attraccess/Attraccess/pull/1436))
- **ATT-603:** remove chat bubble and make AttraccessUser component obviously clickable ([#1438](https://github.com/Attraccess/Attraccess/pull/1438))
- **ATT-604:** build companion binaries in nightly Docker workflow ([#1509](https://github.com/Attraccess/Attraccess/pull/1509))
- **ATT-613:** bundle companion binaries into existing Attraccess Docker image ([#1447](https://github.com/Attraccess/Attraccess/pull/1447))
- **ATT-641:** use Handlebars {{count}} syntax in push notification i18n strings ([#1472](https://github.com/Attraccess/Attraccess/pull/1472))
- **ATT-642:** remove MetricsSettingsCard wrapper, render MetricsSettingsForm directly on MonitoringPage ([#1474](https://github.com/Attraccess/Attraccess/pull/1474))
- **ATT-648:** sort resources by name for web UI and Attractap NFC readers ([#1483](https://github.com/Attraccess/Attraccess/pull/1483))
- **ATT-709:** make usage billing idempotent ([#1491](https://github.com/Attraccess/Attraccess/pull/1491))
- **ATT-714:** lock Attractap certificate after first success, add reset button and 90s connect watchdog ([#1492](https://github.com/Attraccess/Attraccess/pull/1492))
- **ATT-715:** bundle attractap firmware into docker/balena images again ([#1494](https://github.com/Attraccess/Attraccess/pull/1494), [#1485](https://github.com/Attraccess/Attraccess/issues/1485))
- **ATT-717:** resync RGB panel every VBlank to stop permanent screen shift ([#1495](https://github.com/Attraccess/Attraccess/pull/1495), [#1485](https://github.com/Attraccess/Attraccess/issues/1485))
- **ATT-718:** drop stale card-auth trigger while unlocked to prevent stuck UI ([#1498](https://github.com/Attraccess/Attraccess/pull/1498))
- **ATT-719:** correctly bundle and list companion download files ([#1502](https://github.com/Attraccess/Attraccess/pull/1502))
- **ATT-729:** nest switch control inside interactive Switch.Content ([#1515](https://github.com/Attraccess/Attraccess/pull/1515))
- **ATT-730:** retry lost OTA chunks and resume after reconnect instead of aborting ([#1519](https://github.com/Attraccess/Attraccess/pull/1519))
- **ATT-733:** show all roles (custom + system) in user permission form ([#1521](https://github.com/Attraccess/Attraccess/pull/1521))
- **ATT-747:** remove nested <button> in PageHeaderActions overflow trigger ([#1522](https://github.com/Attraccess/Attraccess/pull/1522))
- **ATT-748:** abort SSE connections on unmount to stop post-logout console errors ([#1523](https://github.com/Attraccess/Attraccess/pull/1523))
- **ATT-761:** hide × remove button on locked permission tags ([#1526](https://github.com/Attraccess/Attraccess/pull/1526))
- **ATT-771:** key brute-force counter on IP+username and add coarse per-IP spray guard ([#1524](https://github.com/Attraccess/Attraccess/pull/1524))
- **ATT-775:** re-seed shipped translations on email template reset ([#1525](https://github.com/Attraccess/Attraccess/pull/1525))
- **attractap:** raise TLS rx buffer to fit Let's Encrypt cert chain ([#1520](https://github.com/Attraccess/Attraccess/pull/1520))
- **ci:** stop using secrets context in step-level if conditions ([#1496](https://github.com/Attraccess/Attraccess/pull/1496), [#1447](https://github.com/Attraccess/Attraccess/issues/1447))
- **ci:** override node-gyp to 13.0.1 so native builds work on VS 2026 runners ([#1536](https://github.com/Attraccess/Attraccess/pull/1536))
- **companion:** stop macOS companion relaunching itself on quit ([#1460](https://github.com/Attraccess/Attraccess/pull/1460))
- **docker:** install python3-setuptools so sqlite3 source builds work on Python 3.13 ([#1532](https://github.com/Attraccess/Attraccess/pull/1532))
